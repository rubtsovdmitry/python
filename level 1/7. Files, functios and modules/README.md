...
# Только в примере я буду обрабатывать не английские буквы, а русские. Предлагая воспользоваться готовым файлом, который находится в репозитории и называется pushkin.txt (это Сказка о мертвой царевне и о семи богатырях).
