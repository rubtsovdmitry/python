...
# Нужно написать программу, которая реализует популярную игру "крестики-нолики", используя ООП. Только поле в игре будет большим 20х20. Выигрывает тот, кто сможет по вертикали, горизонтали или диагонали собрать вместе 5 крестиков и ноликов подряд.
